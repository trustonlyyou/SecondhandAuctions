            ...
            <div class="card card-signin flex-row my-5">
                <div class="card-body text-center">
                    ...
                    <form class="form-signin" id="account_info">
                        ...
                        <br>
                        <div class="input-group input-group-md">
                            <input type="text" class="form-control" id="memberBirth" name="memberBirth" maxlength="6"
                                   placeholder="생년월일6자리를 입력해주세요." aria-label="Large"
                                   aria-describedby="inputGroup-sizing-sm">
                        </div>
                        ...
                        <div class="input-group input-group-md">
                            <input type="text" class="form-control" id="account_num" name="account_num"
                                   placeholder="계좌번호를 입력해주세요." aria-label="Large"
                                   aria-describedby="inputGroup-sizing-sm">
                        </div>
                        ...
                        <div>
                            <input type="button" id="accountSubmit" class="btn btn-dark btn-block" value="계좌등록"
                                   disabled>
                        </div>
