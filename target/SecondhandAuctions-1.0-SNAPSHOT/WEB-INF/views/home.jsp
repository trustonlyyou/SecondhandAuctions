        ...
        <div class="row">
            ...
            <div class="col-lg-2">
                ...
                <div class="list-group list-group-flush">
                    <a href="/shop?categoryName=computer" class="list-group-item">컴퓨터</a>
                    <a href="/shop?categoryName=digital" class="list-group-item">전자</a>
                    <a href="/shop?categoryName=cloths" class="list-group-item">의류</a>
                    <a href="/shop?categoryName=shose" class="list-group-item">신발</a>
                    <a href="/shop?categoryName=book" class="list-group-item">도서</a>
                </div>
